<script lang="ts">
	...
	// Used to show/hide chat history upon clicking the history button
	let showChatHistoryDropdown: boolean = true;
...
>
	...
	>
		...
		<ActionButton name={'✨ Assistant'} />
		<ActionButton name={'🗂️ Research'} />
		<ActionButton name={'🗄️ Vault'} />
		<ActionButton name={'🔄 Workflows'} />
		<ActionButton name={'📚 Library'} />
